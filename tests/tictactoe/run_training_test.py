"""Tests for tictactoe.run_training."""
...
from muzero.tictactoe import run_training
...
class RunTicTacToeGameTest(absltest.TestCase):
    def setUp(self):
        super().setUp()
    ...
    @flagsaver.flagsaver
    def test_can_run_agent_resnet(self):
        FLAGS.use_mlp_net = False
        FLAGS.batch_size = 8
        FLAGS.clip_grad = True
        run_training.main(None)
